...
interface FintessClubCenter {
    clubName: string
    location: string
    classes: ClubClass[]
    futureClasses: FutureClubClass[]
...
type FutureClubClass = Omit<ClubClass, 'startsAt'> & { willStartsAt: string }
...
const fitnessClubCenter: FintessClubCenter = {
